...
def notify_broker_client_connected(broker_host, broker_port, broker_bind, broker_java_cp, sale_id, client_id, buyers_count):
    if not broker_host:
        return
...
def main():
    ...
    notify_broker_client_connected(
        args.broker_host,
        args.broker_port,
        args.broker_bind,
        args.broker_java_cp,
